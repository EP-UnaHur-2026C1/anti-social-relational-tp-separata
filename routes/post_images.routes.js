...
const { validarPost_Images, validarPost_ImagesDatos } = require("../middlewares/post_images/validarPost_Images");
...
router.put("/:id", validarPost_ImagesId, validarPost_ImagesDatos, post_imagesController.actualizarPost_Image)
